...
> [吐血整理，全网最全Git命令手册 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/389814854)
...
> `git ci` 不再是一个直接的 Git 命令。然而，过去在早期版本的 Git 中，`git ci` 是 `git ` 的简写形式。
